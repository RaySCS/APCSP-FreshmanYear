...
function generateCharacter() {
    ...
    Nicole = [];
    for(a = 0;a<=2;a++){
        randBackgroundArray = ["Has money saved in the bank", "Doesn't have money saved in the bank"];
...
function displayCharacter(e){
    ...
    if (userChose == "Richard") {
        ...
        for (x=0;x<Richard.length;x++){
            ...
            if (Richard[x] == "Doesn't have money saved in the bank") {
                cash += 20;
            }
        }
    ...
    if (userChose == "Nicole") {
        ...
        for (n=0;n<Nicole.length;n++){
            ...
            if (Nicole[n] == "Doesn't have money saved in the bank") {
                cash += 20;
            }
        }
    }
