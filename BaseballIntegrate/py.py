...
def baseBall():
    ...
    class Player(object):
        def __init__(self):
            ...
            self.average = random.randint(1, 3)
    ...
    for x in range(1, innings):  # loops 9 times for the 9 innings
        ...
        if possession == 1:
            ...
            while outs != 3:
                ...
                determineHit = random.randint(1, 3)#This determines if they hit the ball or not, firstly
                ...
                if determineHit <= team1.players[playerNumber].average:
                    ...
                    hitTriple = False
                    hitHomeRun = False
                    hitType = random.randint(1, 3)#Now this determines what type of hit they get
                    if team1.players[playerNumber].speed > hitType:
                    ...
                    if team1.players[playerNumber].speed > hitType:
                        hitTriple = True
                        hitsHome += 1
                    if team1.players[playerNumber].power > hitType:
                    ...
                    if hitSingle == True:
                        ...
                        for a in range(3, 7):
                            if BasesArrayHome[a] == True:
                                team1.players[playerNumber].AddRuns()
                                runsHome += 1
                    ...
                    if hitHomeRun == True:
                        ...
                        for a in range(3, 7):
                            if BasesArrayHome[a] == True:
                                ...
                                BasesArrayHome[a] = False
                        hitHomeRun = False
                inningHits = inningHits + hitsHome
                possession = 2
        if possession == 2:
            outs = 0
            hit = False
