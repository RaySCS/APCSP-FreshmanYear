...
var BCareerSRC = ["careers/actuary.jpg", "careers/opsmang.jpg", "careers/account.jpg", "financialadvisor.jpg", "careers/HR.jpg", "careers/loan.jpg", "careers/customerservice.jpg", "careers/recep.jpg"];
...
var careerFourSalary = Math.floor(Math.random()*(5000)+3000);
var careerFourSalaryOther = Math.floor(Math.random()*(5000)+3000);
...
function askChoices2() {
    document.getElementById('chooseCollege').value = '';
    // setInterval(function(){ cash += 100;document.getElementById("outputCash").innerHTML = "Cash: " + cash; }, 3000);//USE IN ORDER TO GENERATE MONEY
    ...
    if(CS4==true){
        ...
        document.getElementById("outputCollegeDisplay1").innerHTML = "Career: Software Development Engineer";
        document.getElementById("outputCollegeDisplay2").innerHTML = "Career: Android Software Developer";
