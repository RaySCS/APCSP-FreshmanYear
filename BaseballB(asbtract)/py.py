...
def baseBallSelectionPlayers():
  ...
  class Player(object):
      def __init__(self):
          ...
          self.triple = 0
          self.homerun = 0
          self.HTSA = 0#The A at the end, represents the other teams indidvual players scores.
          self.singleA = 0
          self.doubleA = 0
          self.tripleA = 0
          self.homerunA = 0
  ...
  playBaseball(team1 ,team2)

def playBaseball(team1,team2):
    homeScore = []
    awayScore = []
    possession = 1
    i = 0
            ...
            while outs != 3:
                ...
                if determineHit <= team1.players[playerNumber].average:
                    ...
                    if team1.players[playerNumber].average > 10 and team1.players[playerNumber].average <50 and nothingElse==False:
                        ...
                        hitsTotalHome+=1
                        nothingElse = False
                    if team1.players[playerNumber].speed > 80 and team1.players[playerNumber].speed < 40 and nothingElse==False:
            ...
            while outs != 3:
                ...
                if determineHit <= team2.players[playerNumber].average:
                    ...
                    if team2.players[playerNumber].average > 10 and team2.players[playerNumber].average <50 and nothingElse==False:
                        ...
                        hitsTotalAway+=1
                        nothingElse = False
                    if team2.players[playerNumber].speed > 80 and team2.players[playerNumber].speed < 40 and nothingElse==False:
                        hitDouble = True#All turning true
                        hitsAway += 1
                        hitsTotalAway += 1
                        nothingElse = False
    ...
    team2.show_StatsA()
    if counter == 9:
        ask = input("Would you like to play again with the same stats? Enter 'yes' or 'no'")
        if ask=="yes":
            print("The scores below are the second game which you are allowing to be played")
            playBaseball(team1,team2)
        if ask == "no":
