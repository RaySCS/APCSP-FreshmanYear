...
var day = 1;
setInterval(function(){ day+=1;document.getElementById("outputdays").innerHTML = "Day: " + day; }, 3000);
...
function stocks2(e) {
    ...
    if(ready==true){
        if(stockofChoice=="facebook"){
            var total = quantity*stockPrice1;
            cash-=total;
            alert("Receipt");
        ...
        if(stockofChoice=="apple"){
            var total=quantity*stockPrice2;
            cash-=total;
            alert("Receipt");
            alert("Total Cost of " + quantity + " " + "stocks was: " + total);
            document.getElementById("outputCash").innerHTML = "Cash: " + cash;
        ...
        if(stockofChoice=="tesla"){
            var total=quantity*stockPrice3;
            cash-=total;
            alert("Receipt");
            alert("Total Cost of " + quantity + " " + "stocks was: " + total);
            document.getElementById("outputCash").innerHTML = "Cash: " + cash;
        ...
        if(stockofChoice=="bitcoin"){
            var total=quantity*stockPrice4;
            cash-=total;
            alert("Receipt");
            alert("Total Cost of " + quantity + " " + "stocks was: " + total);
            document.getElementById("outputCash").innerHTML = "Cash: " + cash;
...
function checkStocksProfit() {
    //ASK HOW TO DO SOMETHING EVERY CERTAIN TIME INTERVAL
}
function buyAssets() {
