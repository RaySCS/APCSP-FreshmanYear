...
function familyFeudRoll() {
    ...
    //Wesbite I got questions from: https://hobbylark.com/party-games/family-feud-quiz-free-questions-and-answers
    ...
    document.getElementById("output2").innerHTML = "Question selected: " + questionSelected;
    document.getElementById("output3").innerHTML = "Index of Question: " + indexofQuestion;
    ...
    if (indexofQuestion==0){
        ...
        document.getElementById("output4").innerHTML = "Roll Value: "+ roll;
    }
