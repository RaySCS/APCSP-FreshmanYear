...
var a;
var picsSRC = ["resources/REAL3lives.png", "resources/REALREAL2lives.png", "resources/REALREAL1live.png", "resources/0live.png"];
var placement = 0;
var pictArray = [];
var pictArrayOp = [];
var array2 = [];
...
function drawRealCars() {
    ...
    // if (level==2){
    //     //START NEXT LEVEL, ALSO MAKE SURE FINISH WORKS ON MONDAY
    // }
