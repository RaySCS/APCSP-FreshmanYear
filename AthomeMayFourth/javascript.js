...
var day = 1;
setInterval(function(){ day+=1;document.getElementById("outputdays").innerHTML = "Day: " + day; }, 25000);
...
function generateRandomHouseValue(e) {
    ...
    if(go==true){
        var typeOfPayment = prompt("Would you like to buy the house right away(r) or make installement payments(i)?");
...
function payOffLoans() {
    ...
    if(typeOfLoan.toLowerCase()=="h" || typeOfLoan.toLowerCase()=="m" ){
        ...
        if (house=="single"){
            cash-=howMuch;
            housePrice1-= howMuch;
            document.getElementById("CollegeBalance").innerHTML = "College Loan Left: " + housePrice1 ;
            document.getElementById("outputCash").innerHTML = "Cash: " + cash;
        }
        if(house=="town"){
            cash-=howMuch;
            housePrice2-= howMuch;
            document.getElementById("CollegeBalance").innerHTML = "College Loan Left: " + housePrice2 ;
            document.getElementById("outputCash").innerHTML = "Cash: " + cash;
        }
    }
}
