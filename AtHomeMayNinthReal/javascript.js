...
var randEventsSRC = ["eventspictures/lottery.png","eventspictures/betterluck.jpg", "eventspictures/heli.jpg", "eventspictures/limo.jpg", "eventspictures/uber.jpg", "eventspictures/ref.jpg", "eventspictures/waiter.jpg"];
...
function randomEventsOccur() {
    ...
    if(indexofEvent==0){
        ...
        if(ask_to_Play.toLowerCase()=="yes"){
            ...
            if(askTypeofLottery==250){
                cash-=250;
                document.getElementById("outputCash").innerHTML = "Cash: " + cash;
                var coinFlip = Math.floor(Math.random()*(4));//In  order to pick a random event.
                if(coinFlip==1){
            ...
            if(askTypeofLottery=500){
                cash-=500;
                document.getElementById("outputCash").innerHTML = "Cash: " + cash;
                var coinFlip = Math.floor(Math.random()*(8));//In  order to pick a random event.
                if(coinFlip==3){
                    document.getElementById("events").src = randEventsSRC[0];
            ...
            if(win==false){
                document.getElementById("events").src = randEventsSRC[1];
            }
        }
    }
    if(indexofEvent==1){
        var asktoSwitch = prompt("Would you like to cut your daily expense of gas? Enter yes or no");
    ...
    if(indexofEvent==2){
        var askExtraJob = prompt("Would you like to do a sidejob in order to make more money? Enter yes or no");
        if(askExtraJob=="yes"){
            var askTypeofJob = prompt("Would you like to do a job as an uber driver, a referee at a local basketball league, or a waiter? Enter uber, referee, or waiter");
...
function playAgain() {
    var asktoPlayAgain = prompt("Would you like to play the game again?");
    // if(asktoPlayAgain=="yes"){
    //     cash = 0;
    //     var usertook = " ";
    //     var collegetook = " ";
    //     var CS4 = false;
