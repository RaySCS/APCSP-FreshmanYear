...
function getResponse2(e) {
    ...
    if(CS4==true){
        if(userCareer.toLowerCase()=="s"){
            ...
            setInterval(function(){ cash += careerFourSalary;document.getElementById("outputCash").innerHTML = "Cash: " + cash; }, 60000);//USED IN ORDER TO GENERATE MONEY
        }
        if(userCareer.toLowerCase()=="a"){
            careerTook = "Android Software Developer";
            setInterval(function(){ cash += careerFourSalaryOther;document.getElementById("outputCash").innerHTML = "Cash: " + cash; }, 60000);//EVERY 60 second time interval the user makes their salary.
        }
    }
    if(CS36==true){
...
function randomEventsOccur() {
    ...
    //PL = PlayLottery,
    var randEvents = ["PL", "GM", "TK"];//PL means play lottey, GM means like be a GM, or ref, and TK means have a side job.
