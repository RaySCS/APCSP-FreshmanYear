...
if (ask=="twoPlayer"){
    ...
    realWord = firstUser;//setting whatever the user inputed word to the word to be representated..//
}
function ifTwo() {
...
function reset(){
     ask = prompt("Would you like to play onePlayer or twoPlayer, please specify 'onePlayer' or 'twoPlayer");
...
function hint() {
    ...
    for(d=0;d<statesOne.length;d++){
        if (statesOne[d]==words){
            document.getElementById("output8").innerHTML = "The state is in the midwest";
        }
