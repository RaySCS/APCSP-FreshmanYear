...
def twoPlayer(Attempts,i):
   ...
   while i<5 and gameOver==False:
       i += 1
       Attempts += 1
       twoPlayerScenarios(playerOneGuess,playerTwoGuess,Attempts)#WORK ON TWO PLAYER, KEEP GOING UNTIL GUESSES DONT MATCH!

def twoPlayerScenarios(playerOneGuess, playerTwoGuess, Attempts):
