...
function buyStuff() {
    ...
    askBuy.toLowerCase();
    if (askBuy=="yes"){
        var askPrice = prompt("Would you like to buy the Ford($500) car or Lexus($1000) car? Enter 500 or 1000. If you don't have enough money enter 'no'");
    ...
    askBuy.toLowerCase();
    if (askBuyHouse=="yes"){
        var askPrice = prompt("Would you like to buy an apartment($10,000) or Condominium($20,000)? Enter 10000 or 20000. If you don't have enough money enter 'no'");
